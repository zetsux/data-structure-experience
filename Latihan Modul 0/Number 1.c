...
void forEachElement(SinglyList *list, void (*function)(int *elem)) 
{
    SListNode *temp = list->_head;
...
int main()
{
    ...
    slist_pushBack(&myList, 15);
    slist_pushBack(&myList, 278);
    slist_pushBack(&myList, 39982);
    slist_pushBack(&myList, 412030);
    slist_pushBack(&myList, 5689);
