...
int main()
{
	...
	slist_pushBack(&myList, "Ala");
    slist_pushBack(&myList, "Madura");
    slist_pushBack(&myList, "Nih!");
    slist_pushBack(&myList, "Enak");
    slist_pushBack(&myList, "Banget.");
    
    slist_pushFront(&myList, "Goreng");
    slist_pushFront(&myList, "Bebek");
    slist_pushFront(&myList, "Hadir!!");
